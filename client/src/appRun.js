...
module.exports = ['$rootScope', 'AuthService', '$state', '$timeout', 'localStorageService', 'ProductService',
  function ($rootScope, AuthService, $state, $timeout, localStorageService, ProductService) {
